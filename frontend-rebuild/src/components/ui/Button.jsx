...
function Button({to, href, variant = 'primary', className = '', children, ...rest}) {
    const classes = `font-head inline-flex items-center justify-center gap-2 rounded-fwm-pill px-5 py-3 text-sm 
    font-bold transition active:scale-95 ${VARIANTS[variant]} ${className}`;
