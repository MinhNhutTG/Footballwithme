...
> **✅ Trạng thái: đã hoàn thành và verify (2026-08-06).** Đã fix bug route order (`DELETE /users/me` bị `/:id` (adminOnly) bắt nhầm, báo "Admin access required" — xem commit `51e0d75`). Đã test luồng thật.
